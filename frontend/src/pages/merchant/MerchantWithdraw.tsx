...
import { getMerchantWalletInfo, merchantWithdraw } from '../../api/merchant-wallet';
...
const MerchantWithdraw = () => {
    ...
    return (
      <div className="mx-auto max-w-lg px-4 py-12">
        <Card className="text-center">
          ...
          <div className="mt-6">
            <Button onClick={() => navigate('/merchant/wallet')}>Go to Wallet</Button>
          </div>
        </Card>
      </div>
    );
  ...
  return (
    <div className="mx-auto max-w-lg px-4 py-8">
      <Link to="/merchant/wallet" className="mb-6 inline-flex items-center gap-1 text-sm text-[var(--text-secondary)] hover:text-[var(--text)]">
